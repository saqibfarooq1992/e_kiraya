<template>
    <main>
                        ...
                        <div class="authorization-btn">
                            <div class="row mr-auto">
                                ...
                                <div  class="col-md-2">
                                    ...
                                    type="button"
                                    class="btn btn-warning btn-sm form-control"
                                    v-on:click="editShowProperty(properties)"
                                    data-toggle="tooltip"
                                    data-placement="top"
        ...
        <b-modal id="modal-lg" hide-footer ref="assignToTenant" title="Assign Property To Tenant">
         ...
         <b-modal id="modal-lg" hide-footer ref="editShowProperty" size="lg" title="Update Details">
...
export default {
  ...
  methods: {
    ...
    getTenantData:async function(properties) {
        try {
            const response = await AdminService.getTenantData(this.user_id);
    ...
    editShowProperty: async function (properties) {
                this.editPropertyData = { ...properties };
