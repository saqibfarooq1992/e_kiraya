          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                formData.append('city_id', this.user.city_id); // formData.append('terms', this.user.terms);
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "checkbox" }, [
      _c(
        "label",
        { staticClass: "pull-left checked", attrs: { for: "signing" } },
        [
          _c("input", {
            attrs: { type: "checkbox", name: "signing", id: "signing" }
          }),
          _vm._v(
